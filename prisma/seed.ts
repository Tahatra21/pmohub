...
async function main() {
  ...
  const resource1 = await prisma.resource.upsert({
    ...
    create: {
      ...
      name: 'Jane Engineer',
      type: 'FIELD_ENGINEER',
      description: 'Senior Electrical Engineer with 10+ years experience',
      status: 'AVAILABLE',
      skills: 'Electrical Design, Installation, Testing',
  ...
  const resource2 = await prisma.resource.upsert({
    ...
    create: {
      ...
      name: 'API Test User',
      type: 'IT_DEVELOPER',
      description: 'Software Developer specializing in API development',
      status: 'AVAILABLE',
      skills: 'JavaScript, TypeScript, Node.js, API Development',
      department: 'IT',
      phone: '+1234567893',
      email: 'apitest@example.com',
      maxProjects: 2,
    ...
    data: [
      {
        ...
        prkNumber: 'PRK-2024-001',
        prkName: 'Office Building Electrical Installation',
        kategoriBeban: 'Materials',
        coaNumber: 'COA-5001',
        anggaranTersedia: 25000,
        nilaiPo: 18500,
        nilaiNonPo: 0,
        totalSpr: 18500,
        totalPenyerapan: 18500,
        sisaAnggaran: 6500,
        tahun: 2024,
        projectId: project1.id,
      },
      {
        costCenter: 'CC001',
        manager: 'John Manager',
        prkNumber: 'PRK-2024-002',
        prkName: 'Office Building Labor Costs',
        kategoriBeban: 'Labor',
        coaNumber: 'COA-5002',
        anggaranTersedia: 35000,
        nilaiPo: 22000,
        nilaiNonPo: 0,
        totalSpr: 22000,
        totalPenyerapan: 22000,
        sisaAnggaran: 13000,
        tahun: 2024,
        projectId: project1.id,
      },
      {
        costCenter: 'CC002',
        manager: 'John Manager',
        prkNumber: 'PRK-2024-003',
        prkName: 'Network Infrastructure Equipment',
        kategoriBeban: 'Equipment',
        coaNumber: 'COA-5003',
        anggaranTersedia: 15000,
        nilaiPo: 0,
        nilaiNonPo: 0,
        totalSpr: 0,
        totalPenyerapan: 0,
